    ...
    <div className="">
      ...
      <div className="xl:hidden">
        ...
        >
          ...
          {/* <Link href={'/Contact'} className="w-[70%] mx-auto p-4 divbord flex justify-center">
      ...
      <div
        className="bg-white border-2 p-1 rounded-lg border-[#B8FFC7] xl:hidden fixed top-0 right-0 m-5"
        onClick={handleToggleMenu}
      >
        <svg
